...
import { subscriptions, type Subscription, type SubscriptionStatus } from "@/data/dummy"
...
export default function IndividualProfile({ name, onClose }: IndividualProfileProps) {
  ...
  const updateField = (id: string, field: keyof Subscription, value: string | number) => {
    setVehicles((prev) =>
      ...
      <DialogContent className="max-w-6xl w-[96vw] max-h-[95vh] h-[95vh] flex flex-col p-0 gap-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-3 space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            <div className="rounded-md border border-border bg-muted/30 px-3 py-2">
              <p className="text-[0.6rem] uppercase tracking-widest text-muted-foreground font-semibold">Total Amount Owed</p>
