                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="bg-muted/50">
                          ...
                          <th className="px-4 py-2.5 text-left text-[0.65rem] font-semibold uppercase tracking-widest text-muted-foreground">SMS</th>
                      ...
                      <tbody className="divide-y divide-border">
                        {vehicles.map((v) => (
                          <tr key={v.id} className="hover:bg-muted/20 transition-colors">
                            ...
                            <td className="px-4 py-2.5 whitespace-nowrap">
                              {v.sms_status === 'Sent' ? (
                                <Badge variant="outline" className="text-[0.65rem] font-semibold bg-emerald-50 text-emerald-700 border-emerald-200">✓ Sent</Badge>
                              ) : v.sms_status === 'Failed' ? (
                                <Badge variant="outline" className="text-[0.65rem] font-semibold bg-red-50 text-red-700 border-red-200">✕ Failed</Badge>
