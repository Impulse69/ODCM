...
import { User, Phone, Car, MapPin, TrendingDown } from "lucide-react";
import {
  getIndividualById,
  ...
  useEffect(() => {
    if (id) {
      ...
      Promise.all([
        ...
        getIndividualSubscriptions(id),
        getPlans()
      ]).then(([cust, vehs, allPlans]) => {
        setCustomer(cust);
        setVehicles(vehs);
        setPlans(allPlans);
        setLoading(false);
            ...
            <>
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-bold tracking-tight">Vehicles & Billing Status</p>
